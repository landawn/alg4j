...
public class BinaryTreeTraverser<T> {
    ...
    private final class InOrderIterator extends ImmutableIterator<T> {
        private final Deque<T> stack;
        private T next = null;

        InOrderIterator(T startNode) {
            N.requireNonNull(startNode);
    ...
    private final class PreOrderIterator extends ImmutableIterator<T> {
        private final Deque<T> stack;
     ...
     *
     */
    private final class PostOrderIterator extends ImmutableIterator<T> {
        private final Deque<T> stack;
