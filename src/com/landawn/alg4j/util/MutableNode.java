...
public class MutableNode<T> {
    ...
    public <E extends Exception> boolean setValueIf(final T newValue, final Try.Predicate<? super MutableNode<T>, E> predicate) throws E {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MutableNode) {
            return N.equals(((MutableNode<T>) obj).value, value);
        }
